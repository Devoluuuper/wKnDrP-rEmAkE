...
exports.ox_target:addGlobalVehicle({
	{
        ...
        canInteract = function(entity)
            return not cache.vehicle and (ESX.PlayerData.job.name == 'police' and ESX.PlayerData.job.onDuty) and not isClamped(entity)
        end,
...

    {
		...
		label = 'Eemalda kand',
        canInteract = function(entity)
            return not cache.vehicle and (ESX.PlayerData.job.name == 'police' and ESX.PlayerData.job.onDuty) and isClamped(entity)
        end,
        onSelect = function(data)
