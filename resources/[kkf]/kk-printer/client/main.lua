...
for k,v in pairs(cfg.locations) do
    ...
    function point:onEnter()
        -- if ESX.PlayerData.job.name == point.job and ESX.PlayerData.job.onDuty and ESX.PlayerData.job.permissions.function7 then
		if ESX.PlayerData.job.name == point.job and ESX.PlayerData.job.onDuty then
			ESX.ShowInteraction('Prindi', 'E')
        end
    end
