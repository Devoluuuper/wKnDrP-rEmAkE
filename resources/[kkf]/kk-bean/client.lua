...
CreateThread(function()
    ...
    KKF.CreateBlip('bean', cfg.position, 'Bean Machine', 408, 28, 0.7)
end)
        ...
        options = {
            {
                ...
                canInteract = function()
                    return v.type == 'plate' or (KKF.PlayerData.job.name == 'bean' and (KKF.PlayerData.job.onDuty or v.type == 'duty'))
                end,
