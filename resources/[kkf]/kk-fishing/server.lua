...
lib.callback.register('kk-fishing:sell', function(source, item)
    ...
    TriggerClientEvent('KKF.UI.ShowNotification', source, 'success', ('Müüsid %s koguses %d hinnaga $%d.'):format(KKF.GetItemLabel(item), count, totalPrice))
end)
...
lib.callback.register('kk-fishing:buy', function(source, item, amount)
    ...
    TriggerClientEvent('KKF.UI.ShowNotification', source, 'success', ('Ostsid %s koguses %d hinnaga $%d.'):format(KKF.GetItemLabel(item), amount, finalPrice))
end)
...
lib.callback.register('kk-fishing:recieveFish', function(source)
    ...
    -- TriggerClientEvent('KKF.UI.ShowNotification', source, 'success', ('Püüdsid %s koguses %d.'):format(KKF.GetItemLabel(randomFish), amount))
end)
