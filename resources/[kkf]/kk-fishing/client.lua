...
local function activateScript()
    ...
    for i = 1, #cfg.zones do
        ESX.CreateBlip('fish_' .. i, cfg.zones[i].coords, 'Kalastus', 317, 52, 1.0)
    ...
    local function registerPeds()
        SetTimeout(5000, function()
            ...
            ESX.CreateBlip('fishMan', cfg.fishingPed.xyz, 'Kalamees', 317, 52, 1.0)
