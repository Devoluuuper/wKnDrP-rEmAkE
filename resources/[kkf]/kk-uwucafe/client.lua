...
CreateThread(function()
    ...
    KKF.CreateBlip('uwucafe', cfg.position, 'Uwu Cafe', 480, 48, 0.7)
end)
        ...
        options = {
            {
                ...
                canInteract = function()
                    return v.type == 'plate' or (KKF.PlayerData.job.name == 'uwucafe' and (KKF.PlayerData.job.onDuty or v.type == 'duty'))
                end,
