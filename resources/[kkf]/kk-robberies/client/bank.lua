                    ...
                    CreateThread(function()
                        ...
                        function point:onEnter()
                            if self.type == 'hack' then
                                ESX.ShowInteraction('Alusta häkkimisega', 'E')
                            elseif self.type == 'drill' then
                                ESX.ShowInteraction('Alusta puurimisega', 'E')
                            elseif self.type == 'bomb' then
                                ESX.ShowInteraction('Alusta pommi paigaldamisega', 'E')
                            elseif self.type == 'collect' then
                                ESX.ShowInteraction('Korja raha','E')
                            end
                        end
