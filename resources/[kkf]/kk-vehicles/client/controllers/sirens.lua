...
function RequestSirenStateUpdate(pVehicle)
    ...
    SetTimeout(50, function()
        ...
        TriggerServerEvent('kk-vehicles:server:updateSirenState', netId, sirenState, sirenPreset)
    end)
end
...
RegisterNetEvent('kk-vehicles:client:updateSirenState', function(pNetId, pSirenState, pSirenPreset)
...
CreateThread(function()
    RegisterKeyMapping('toggleSirenLights', 'Sireeni tuled sisse/välja', 'keyboard', 'Q')
    RegisterKeyMapping('toggleSiren', 'Sireeni sisse/välja lülitamine', 'keyboard', 'LMENU')
    RegisterKeyMapping('cycleSiren', 'Sireeni helivahetus', 'keyboard', 'R')
    RegisterKeyMapping('+sirenHorn', 'Sireeni signaal', 'keyboard', 'E')
end)