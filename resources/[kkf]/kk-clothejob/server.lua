            ...
            for k, v in pairs(shopData.items) do
                ...
                if xItem then
                    if tonumber(xItem.count) > 0 then
                        ...
                        ESX.UpdateCheck(xPlayer.source, 'add', reward)
        
                        exports['kk-scripts']:sendLog(xPlayer.identifier, 'TÖÖD', 'Müüs eseme ' .. ESX.GetItemLabel(k) .. ' ' .. xItem.count .. 'tk hinnaga ' .. reward .. '.')
