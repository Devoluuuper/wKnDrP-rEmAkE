...
KKF.RegisterUsableItem('alecoq', function(source)
...
KKF.RegisterUsableItem('taurus', function(source)
	local xPlayer = KKF.GetPlayerFromId(source)
...
KKF.RegisterUsableItem('bock', function(source)
	local xPlayer = KKF.GetPlayerFromId(source)
...
KKF.RegisterUsableItem('wine', function(source)
	local xPlayer = KKF.GetPlayerFromId(source)

	TriggerClientEvent('kk-needs:onDrinkAlochol', source, 10000, 'wine')
end)

KKF.RegisterUsableItem('vodka', function(source)
	local xPlayer = KKF.GetPlayerFromId(source)
...
KKF.RegisterUsableItem('tequila', function(source)
	local xPlayer = KKF.GetPlayerFromId(source)
...
KKF.RegisterUsableItem('whisky', function(source)
	local xPlayer = KKF.GetPlayerFromId(source)
