...
Drilling.Init = function()
  if Drilling.Scaleform then
    Scaleformz.UnloadMovie(Drilling.Scaleform)
  end

  Drilling.Scaleform = Scaleformz.LoadMovie("DRILLING")
  ...
  Scaleformz.PopFloat(Drilling.Scaleform,"SET_SPEED",           0.0)
  Scaleformz.PopFloat(Drilling.Scaleform,"SET_DRILL_POSITION",  0.0)
  Scaleformz.PopFloat(Drilling.Scaleform,"SET_TEMPERATURE",     0.0)
  Scaleformz.PopFloat(Drilling.Scaleform,"SET_HOLE_DEPTH",      0.0)
end
...
Drilling.Update = function(callback)
	...
	if Drilling.Result then -- puuri eluiga
		TriggerServerEvent("KKF.Player.RemoveItem", 'drill', 1)
	end
...
Drilling.HandleControls = function()
  ...
  if last_pos < Drilling.DrillPos then
    if Drilling.DrillSpeed > 0.4 then
      ...
      Scaleformz.PopFloat(Drilling.Scaleform,"SET_DRILL_POSITION",Drilling.DrillPos)
    else
  ...
  if last_speed ~= Drilling.DrillSpeed then
    Scaleformz.PopFloat(Drilling.Scaleform,"SET_SPEED",Drilling.DrillSpeed)
  end

  if last_temp ~= Drilling.DrillTemp then    
    Scaleformz.PopFloat(Drilling.Scaleform,"SET_TEMPERATURE",Drilling.DrillTemp)
  end
