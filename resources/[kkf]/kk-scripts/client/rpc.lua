...
lib.callback.register('KKF.RPC.GetVehiclesInArea', function(radius)
    local vehicles = KKF.Game.GetVehiclesInArea(GetEntityCoords(cache.ped), radius)
    local returnable = {}
...
lib.callback.register('KKF.RPC.GetPedsInArea', function(radius)
    local peds = KKF.Game.GetPedsInArea(GetEntityCoords(cache.ped), radius)
    local returnable = {}
...
lib.callback.register('KKF.RPC.GetObjectsInArea', function(radius)
    local objects = KKF.Game.GetObjectsInArea(GetEntityCoords(cache.ped), radius)
    local returnable = {}
