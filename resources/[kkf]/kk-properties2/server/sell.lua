...
local function GetPlayer(src)
    return KKF.GetPlayerFromId(src)
end
...
RegisterNetEvent('kk-properties2:server:sellProperty', function(propertyId, targetCitizenId, price)
    ...
    local targetPlayer = KKF.GetPlayerFromIdentifier(targetCitizenId)
...
KKF.RegisterCommand('revokeProperty', 'admin', function(xPlayer, args, showError)
