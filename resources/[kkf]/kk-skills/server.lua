    ...
    if xPlayer then
        ...
        if cachedSkills then
            if cachedSkills[skill] then
                ...
                progressToAdd = math.floor(progressToAdd * 100 + 0.5) / 100
                decodedSkills[skill].progress = decodedSkills[skill].progress + progressToAdd

                -- Teavitus progressi kohta
                TriggerClientEvent('KKF.UI.ShowNotification', playerId, 'info', "Oskus: "..skill.." +"..progressToAdd)
                ...
                if decodedSkills[skill].progress >= 100 then
                    ...
                    -- Teavitus taseme tõusu kohta
                    TriggerClientEvent('KKF.UI.ShowNotification', playerId, 'success', "Saavutasid uue taseme! Oskus: "..skill..", Tase: "..decodedSkills[skill].lvl)
