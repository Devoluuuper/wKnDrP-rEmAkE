...
CreateThread(function()
    ...
    ESX.CreateBlip('burgershot', cfg.position, 'Burgershot', 106, 46, 0.7)
        ...
        options = {
            {
                ...
                canInteract = function()
                    return v.type == 'plate' or (ESX.PlayerData.job.name == 'burgershot' and (ESX.PlayerData.job.onDuty or v.type == 'duty'))
                end,
