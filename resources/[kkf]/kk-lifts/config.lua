ZONES = {
    ...
    ['mti_up_1'] = {
        label = "B-korpus 1",
        coords = vec4(2504.4262695312, -342.11868286133, 94.084228515625, 130.39370727539),
        interactDistance = 1.5,
        renderDistance = 5.0,
        directions = {
            'mti_up_3',
    ...
    ['mti_up_3'] = {
        label = "B-korpus 3",
        coords = vec4(2504.228515625, -342.40878295898, 101.8857421875, 130.39370727539),
        interactDistance = 1.5,
        renderDistance = 5.0,
        directions = {
            'mti_up_1',
    ...
    ['mti_up_4'] = {
        label = "B-korpus 4",
        coords = vec4(2504.1625976562, -342.47473144531, 105.67687988281, 130.39370727539),
        interactDistance = 1.5,
        renderDistance = 5.0,
        directions = {
            'mti_up_1',
    ...
    ['mti_down_2'] = {
        label = "A-korpus 2",
        coords = vec4(2504.3603515625, -433.1340637207, 99.10546875, 314.64566040039),
        interactDistance = 1.5,
        renderDistance = 5.0,
        directions = {
            'mti_down_4'
    ...
    ['mti_down_4'] = {
        label = "A-korpus 4",
        coords = vec4(2504.333984375, -433.30548095703, 106.90698242188, 314.64566040039),
        interactDistance = 1.5,
        renderDistance = 5.0,
        directions = {
            'mti_down_2'
