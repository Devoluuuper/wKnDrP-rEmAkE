...
Item('giftbox', function(event, item, inventory, data, slot)
	if event == 'usedItem' then
    	Inventory.AddItem(inventory, 'bandage', 5)
		Inventory.AddItem(inventory, 'lockpick', 2)
		Inventory.AddItem(inventory, 'phone', 1)
		Inventory.AddItem(inventory, 'waffles', 2)
		Inventory.AddItem(inventory, 'hot_chocolate', 2)
		Inventory.AddItem(inventory, 'idcard', 1)
	end
end)

----- Politsei
Item('prop_roadcone02a', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'prop_roadcone02a')
	end
end)

Item('prop_barrier_work05', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'prop_barrier_work05')
	end
end)

Item('prop_sign_road_01a', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'prop_sign_road_01a')
	end
end)

Item('prop_gazebo_03', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'prop_gazebo_03')
	end
end)

Item('prop_worklight_03b', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'prop_worklight_03b')
	end
end)

Item('xm_prop_base_tripod_lampa', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'xm_prop_base_tripod_lampa')
	end
end)

Item('bzzz_dream_of_lights_blue', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_dream_of_lights_blue')
	end
end)

Item('bzzz_dream_of_lights_green', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_dream_of_lights_green')
	end
end)

Item('bzzz_dream_of_lights_orange', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_dream_of_lights_orange')
	end
end)

Item('bzzz_dream_of_lights_pink', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_dream_of_lights_pink')
	end
end)

Item('bzzz_dream_of_lights_purple', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_dream_of_lights_purple')
	end
end)

Item('bzzz_dream_of_lights_red', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_dream_of_lights_red')
	end
end)

Item('bzzz_dream_of_lights_white', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_dream_of_lights_white')
	end
end)

Item('bzzz_dream_of_lights_yellow', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_dream_of_lights_yellow')
	end
end)

Item('bzzz_world_of_lamps_blue', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_world_of_lamps_blue')
	end
end)

Item('bzzz_world_of_lamps_green', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_world_of_lamps_green')
	end
end)

Item('bzzz_world_of_lamps_orange', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_world_of_lamps_orange')
	end
end)

Item('bzzz_world_of_lamps_pink', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_world_of_lamps_pink')
	end
end)

Item('bzzz_world_of_lamps_purple', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_world_of_lamps_purple')
	end
end)

Item('bzzz_world_of_lamps_red', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_world_of_lamps_red')
	end
end)

Item('bzzz_world_of_lamps_white', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_world_of_lamps_white')
	end
end)

Item('bzzz_world_of_lamps_yellow', function(event, item, inventory, data, slot)
	if event == 'usingItem' then
		TriggerClientEvent('kk-police:client:spawnObject', -1, 'bzzz_world_of_lamps_yellow')
	end
end)
