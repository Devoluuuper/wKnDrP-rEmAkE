...
RegisterNetEvent('KKF.Player.Unloaded', function()
	ESX.PlayerData = {}; SetPedArmour(cache.ped, 0)
...
RegisterNetEvent('KKF.Player.ReloadLicenses', function(licenses)
	...
	ESX.SetPlayerData('licenses', licenses)
end)
...
RegisterNetEvent('KKF.SetVehicleProperties', function(netId, data)
	...
	ESX.Game.RequestNetworkControlOfEntity(entity)
    ESX.Game.SetVehicleProperties(entity, json.decode(data))
end)
