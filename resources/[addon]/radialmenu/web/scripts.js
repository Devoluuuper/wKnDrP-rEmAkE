...
var faForm = {
  prefix: 'fas',
  iconName: 'forms',
  icon: [448, 512, [61460, "form"], "f2ed", "M448 75.2v361.7c0 24.3-19 43.2-43.2 43.2H43.2C19.3 480 0 461.4 0 436.8V75.2C0 51.1 18.8 32 43.2 32h361.7c24 0 43.1 18.8 43.1 43.2zm-37.3 361.6V75.2c0-3-2.6-5.8-5.8-5.8h-9.3L285.3 144 224 94.1 162.8 144 52.5 69.3h-9.3c-3.2 0-5.8 2.8-5.8 5.8v361.7c0 3 2.6 5.8 5.8 5.8h361.7c3.2 .1 5.8-2.7 5.8-5.8zM150.2 186v37H76.7v-37h73.5zm0 74.4v37.3H76.7v-37.3h73.5zm11.1-147.3l54-43.7H96.8l64.5 43.7zm210 72.9v37h-196v-37h196zm0 74.4v37.3h-196v-37.3h196zm-84.6-147.3l64.5-43.7H232.8l53.9 43.7zM371.3 335v37.3h-99.4V335h99.4z"]
};
var faForm = faForm;
var faTrashCan = {
  prefix: 'fas',
...
var faTshirt = {
  prefix: 'fas',
  iconName: 'tshirt',
  icon: [640, 512, [127917, "shirt"], "f630", "M631.2 96.5L436.5 0C416.4 27.8 371.9 47.2 320 47.2S223.6 27.8 203.5 0L8.8 96.5c-7.9 4-11.1 13.6-7.2 21.5l57.2 114.5c4 7.9 13.6 11.1 21.5 7.2l56.6-27.7c10.6-5.2 23 2.5 23 14.4V480c0 17.7 14.3 32 32 32h256c17.7 0 32-14.3 32-32V226.3c0-11.8 12.4-19.6 23-14.4l56.6 27.7c7.9 4 17.5 .8 21.5-7.2L638.3 118c4-7.9 .8-17.6-7.1-21.5z"]
};
var faTshirt = faTshirt;

var faHat = {
  prefix: 'fas',
  iconName: 'hat',
  icon: [640, 512, [127917, "hat"], "f630", "M490 296.9C480.5 239.5 450.5 64 392.3 64c-14 0-26.5 5.9-37 14a58.2 58.2 0 0 1 -70.6 0c-10.5-8-23-14-37-14-58.2 0-88.2 175.5-97.7 232.9C188.8 309.5 243.7 320 320 320s131.2-10.5 170-23.1zm142.9-37.2a16 16 0 0 0 -19.8 1.5c-1 .9-101.3 90.8-293.2 90.8-190.8 0-292.2-89.9-293.2-90.8A16 16 0 0 0 1 278.5C1.7 280.6 78.3 480 320 480s318.3-199.5 319-201.5a16 16 0 0 0 -6.1-18.8z"]
};
var faHat = faHat;
...
var faPants = {
  prefix: 'fas',
  iconName: 'pants',
  icon: [256, 512, [127917, "pants"], "f630", "M96 496V16c0-8.8-7.2-16-16-16H48c-8.8 0-16 7.2-16 16v480c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16zm128 0V16c0-8.8-7.2-16-16-16h-32c-8.8 0-16 7.2-16 16v480c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16z"]
};
var faPants = faPants;
...
var faCircle = {
  prefix: 'fas',
  iconName: 'cirlce',
  icon: [512, 512, [127917, "pants"], "f630", "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512z"]
};
var faCircle = faCircle;

var faDoorClose = {
  prefix: 'fas',
  iconName: 'close-door',
  icon: [576, 512, [127917, "door-closed"], "f630", "M96 64c0-35.3 28.7-64 64-64H416c35.3 0 64 28.7 64 64V448h64c17.7 0 32 14.3 32 32s-14.3 32-32 32H432 144 32c-17.7 0-32-14.3-32-32s14.3-32 32-32H96V64zM384 288a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"]
};
var faDoorClose = faDoorClose;
...
const iconMap = {
  ...
  'vest': faShieldAlt,
  'bag': faShoppingBag,
  'animations': faFaceGrinTongueSquint,
  'circle': faCircle,
  ...
  'dead': faSadCry,
  'wrench': faWrench,
  'enter-door': faDoorOpen,
  'close-door': faDoorClose,
  'park': faParking,
  'trash': faTrash,
  'hands': faHands,
  'search': faSearch,
...
const _tmpl$ = /*#__PURE__*/template(`<svg><g class="icon-container" transform="translate(56, -12)"><path class="hover-ef-bg" d="M63.75 16.1651L110.578 43.201C112.279 44.1834 113.328 45.9991 113.328 47.9641V102.036C113.328 104.001 112.279 105.817 110.578 106.799L63.75 133.835C62.0483 134.817 59.9517 134.817 58.25 133.835L11.4224 106.799C9.72074 105.817 8.67245 104.001 8.67245 102.036V47.9641C8.67245 45.9991 9.72075 44.1834 11.4225 43.201L58.25 16.1651C59.9517 15.1826 62.0483 15.1826 63.75 16.1651Z" fill="#181F29" fill-opacity="1" stroke=""></path><path class="interaction-hover" d="M63.75 16.1651L110.578 43.201C112.279 44.1834 113.328 45.9991 113.328 47.9641V102.036C113.328 104.001 112.279 105.817 110.578 106.799L63.75 133.835C62.0483 134.817 59.9517 134.817 58.25 133.835L11.4224 106.799C9.72074 105.817 8.67245 104.001 8.67245 102.036V47.9641C8.67245 45.9991 9.72075 44.1834 11.4225 43.201L58.25 16.1651C59.9517 15.1826 62.0483 15.1826 63.75 16.1651Z" fill="url(#paint0_radial_358_3992)" fill-opacity="0.85" stroke="#985f31"></path><svg width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg" x="50" y="41.5"><path fill-rule="evenodd" clip-rule="evenodd" d="M9.25958 0.088126C9.10897 0.142752 8.90087 0.248038 8.79715 0.322116C8.69338 0.396194 6.7336 2.37591 4.44202 4.72147C1.0525 8.19087 0.256331 9.02928 0.172585 9.21762C0.0200753 9.56025 -0.034954 9.94754 0.021925 10.2773C0.126018 10.8806 -0.0341676 10.6993 4.44202 15.281C6.7336 17.6265 8.69347 19.6063 8.79733 19.6805C9.31318 20.0489 9.9776 20.1022 10.5643 19.8222C10.8206 19.7 10.9795 19.5661 11.4792 19.0516C11.9156 18.6021 12.1192 18.3545 12.2109 18.1615C12.4387 17.6822 12.4479 17.1265 12.2366 16.6087C12.1433 16.3801 11.7854 15.997 9.02984 13.1763L5.928 10.0012L9.02984 6.82611C11.7854 4.00543 12.1433 3.6223 12.2366 3.39373C12.4477 2.87632 12.4387 2.32085 12.2113 1.84093C12.119 1.64613 11.9194 1.4042 11.4753 0.949018C10.9753 0.436657 10.8106 0.298037 10.558 0.17736C10.1405 -0.0221176 9.65561 -0.0554503 9.25958 0.088126ZM19.9957 0.0402043C19.4941 0.169569 19.5099 0.154745 15.1191 4.63507C11.3575 8.47349 10.8882 8.96847 10.7796 9.21228C10.5582 9.70935 10.5517 10.2467 10.7609 10.759C10.8548 10.9893 11.3091 11.4698 15.0783 15.3269C19.1098 19.4524 19.3055 19.645 19.6351 19.8121C19.9563 19.9751 20.0079 19.9869 20.4005 19.9869C20.7926 19.9869 20.8452 19.9749 21.167 19.8125C21.4568 19.6663 21.6063 19.5406 22.0948 19.0327C22.7177 18.385 22.8717 18.1454 22.9665 17.6772C23.0324 17.3516 23.002 17.0434 22.867 16.6661C22.7769 16.4146 22.5847 16.2078 19.6444 13.1999L16.5177 10.0012L19.6444 6.8025C22.5543 3.82569 22.7776 3.58575 22.8636 3.34411C22.9972 2.96872 23.03 2.63917 22.9655 2.32033C22.8718 1.85731 22.7161 1.61581 22.0948 0.969697C21.3852 0.231844 21.0762 0.0452562 20.5128 0.0142841C20.3239 0.00394433 20.0912 0.0156061 19.9957 0.0402043ZM20.867 0.855724C20.9411 0.895052 21.2637 1.20015 21.584 1.53371C22.1133 2.08493 22.1717 2.16288 22.2247 2.38931C22.2943 2.68586 22.2605 2.92037 22.111 3.17887C22.0509 3.28274 20.575 4.82303 18.8312 6.6017C15.8399 9.65279 15.6606 9.84509 15.6606 10.0012C15.6606 10.1574 15.8399 10.3497 18.8312 13.4007C20.575 15.1794 22.0509 16.7197 22.111 16.8236C22.2605 17.0821 22.2943 17.3166 22.2247 17.6131C22.1717 17.8396 22.1133 17.9175 21.584 18.4687C21.2637 18.8023 20.9433 19.1062 20.872 19.144C20.6832 19.2443 20.3388 19.2735 20.0999 19.2095C19.9088 19.1583 19.5509 18.8062 15.7152 14.8962C13.2067 12.339 11.5011 10.5649 11.4447 10.4542C11.3183 10.206 11.3183 9.79631 11.4447 9.54825C11.5011 9.43782 13.2064 7.66255 15.6946 5.12406C18.9329 1.82034 19.8907 0.869038 20.033 0.815026C20.2515 0.732119 20.6729 0.752704 20.867 0.855724Z" fill="white"></path></svg><text fill="#ffffff8c" font-family="gilroy400" font-size="14" x="60" y="75" text-anchor="middle" dy="14"><tspan>Eelmine</tspan><tspan x="60" y="104">leht</svg>`, false, true),
  ...
  _tmpl$6 = /*#__PURE__*/template(`<svg width="255" height="150" viewBox="0 0 424 150" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="paint0_radial_357_379" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(53 61) rotate(90) scale(69.3593 39.0146)"><stop stop-color="#181F29" stop-opacity="0.92"></stop><stop offset="1" stop-color="#181F29"></stop></radialGradient><radialGradient id="paint1_radial_357_379" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(48 61) rotate(55.8786) scale(110.527 1790.87)"><stop stop-color="white"></stop><stop offset="1" stop-color="white"></stop></radialGradient><radialGradient id="paint0_radial_87_2" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(60.5 7.5) rotate(90) scale(58.5)"><stop stop-color="#0EA5E9"></stop><stop offset="1" stop-color="#0EA5E9" stop-opacity="0"></stop></radialGradient><linearGradient id="paint1inear_87_2" x1="60.5" y1="0" x2="60.5" y2="39" gradientUnits="userSpaceOnUse"><stop stop-color="#0EA5E9"></stop><stop offset="1" stop-color="#0EA5E9" stop-opacity="0"></stop></linearGradient><radialGradient id="paint2_radial_87_2" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(60.5 142.5) rotate(-90) scale(58.5)"><stop stop-color="#0EA5E9"></stop><stop offset="1" stop-color="#0EA5E9" stop-opacity="0"></stop></radialGradient><linearGradient id="paint3inear_87_2" x1="60.5" y1="150" x2="60.5" y2="111" gradientUnits="userSpaceOnUse"><stop stop-color="#0EA5E9"></stop><stop offset="1" stop-color="#0EA5E9" stop-opacity="1"></stop></linearGradient><radialGradient id="paint4_radial_87_2" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(61 75) rotate(45) scale(115.023)"><stop stop-color="#0EA5E9"></stop><stop offset="1" stop-color="#0EA5E9" stop-opacity="0">`),
  _tmpl$7 = /*#__PURE__*/template(`<svg><g class="icon-container"><path class="hover-child-t" d="M63.25 2.16506L91.458 18.451C93.1597 19.4334 94.208 21.2491 94.208 23.2141V55.7859C94.208 57.7509 93.1597 59.5666 91.458 60.549L63.25 76.8349C61.5483 77.8174 59.4517 77.8174 57.75 76.8349L29.542 60.549C27.8403 59.5666 26.792 57.7509 26.792 55.7859V23.2141C26.792 21.2491 27.8403 19.4334 29.542 18.451L57.75 2.16506C59.4517 1.18258 61.5483 1.18258 63.25 2.16506Z" fill="url(#paint0_radial_87_2)" fill-opacity="0.85" stroke="url(#paint1inear_87_2)"></path><path class="hover-child-b" d="M63.25 147.835L91.458 131.549C93.1597 130.567 94.208 128.751 94.208 126.786V94.2141C94.208 92.2491 93.1597 90.4334 91.458 89.451L63.25 73.1651C61.5483 72.1826 59.4517 72.1826 57.75 73.1651L29.542 89.451C27.8403 90.4334 26.792 92.2491 26.792 94.2141V126.786C26.792 128.751 27.8403 130.567 29.542 131.549L57.75 147.835C59.4517 148.817 61.5483 148.817 63.25 147.835Z" fill="url(#paint2_radial_87_2)" fill-opacity="0.85" stroke="url(#paint3inear_87_2)"></path><path class="hover-ef-bg" d="M63.75 16.1651L110.578 43.201C112.279 44.1834 113.328 45.9991 113.328 47.9641V102.036C113.328 104.001 112.279 105.817 110.578 106.799L63.75 133.835C62.0483 134.817 59.9517 134.817 58.25 133.835L11.4224 106.799C9.72074 105.817 8.67245 104.001 8.67245 102.036V47.9641C8.67245 45.9991 9.72075 44.1834 11.4225 43.201L58.25 16.1651C59.9517 15.1826 62.0483 15.1826 63.75 16.1651Z" fill="#181F29" fill-opacity="1" stroke=""></path><path class="hover-ef" d="M63.75 16.1651L110.578 43.201C112.279 44.1834 113.328 45.9991 113.328 47.9641V102.036C113.328 104.001 112.279 105.817 110.578 106.799L63.75 133.835C62.0483 134.817 59.9517 134.817 58.25 133.835L11.4224 106.799C9.72074 105.817 8.67245 104.001 8.67245 102.036V47.9641C8.67245 45.9991 9.72075 44.1834 11.4225 43.201L58.25 16.1651C59.9517 15.1826 62.0483 15.1826 63.75 16.1651Z" fill="url(#paint4_radial_87_2)" fill-opacity="0.85" stroke="#0EA5E9"></path><text fill="#ffffff8c" font-family="gilroy400" font-size="14" x="60" y="84" text-anchor="middle"></svg>`, false, true),
...
const interfaceView = props => {
  ...
  const InterfaceInteractionItems = () => {
    return (() => {
      ...
      insert(_el$12, () => isTopLevel() && !activeSmall() ? "Sulge" : "Tagasi");
