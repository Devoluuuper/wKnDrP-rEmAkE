...
--[[ FRAMEWORK OPTIONS ]] --
Config.Framework = "KKF"
--[[
    Supported frameworks:
        * auto: auto-detect framework
        * KKF: es_extended - https://github.com/KKF-framework/KKF-legacy
...
Config.Valet.DisableDamages = false -- disable vehicle damages (engine & body health) on KKF
