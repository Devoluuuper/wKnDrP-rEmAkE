...
Citizen.CreateThread(function()
    ...
    --HLApartment4.LoadDefault()          -- -773.407 341.766 211.397 (EclipseTowers, Apt 3) --- HAIGLA
    ...
    ImportVehicleWarehouse.LoadDefault()       -- Vehicle warehouse: 994, -3002, -39
    ...
    -- =---------------------- [DLC: Smuggler's Run] ---------------------=
    -- ====================================================================
   SmugglerHangar.LoadDefault()    -- -1267, -3013, -49

    -- ====================================================================
    -- =-------------------- [DLC: The Doomsday Heist] -------------------=
    -- ====================================================================
    --DoomsdayFacility.LoadDefault() -- 483, 4810, -58
    -- =----------------------- [DLC: After Hours] -----------------------=
    -- ====================================================================
