...
-- Dumping data for table kkf.baninfo: ~0 rows (approximately)
DELETE FROM `baninfo`;
...
-- Dumping data for table kkf.billing: ~0 rows (approximately)
DELETE FROM `billing`;
...
-- Dumping data for table kkf.jobs: ~11 rows (approximately)
DELETE FROM `jobs`;
INSERT INTO `jobs` (`name`, `label`, `type`, `max_count`, `money`, `properties`, `safe`) VALUES
	...
	('uwucafe', 'UwU Cafe', 'legal', 20, 856130, '{"stash":true}', 500);
...
-- Dumping data for table kkf.ox_inventory: ~0 rows (approximately)
...
-- Dumping data for table kkf.society_logs: ~59 rows (approximately)
...
-- Dumping data for table kkf.users: ~0 rows (approximately)
DELETE FROM `users`;
...
-- Dumping data for table kkf.user_labs: ~0 rows (approximately)
...
INSERT INTO `user_plants` (`id`, `data`) VALUES
	(27, '{"health":{"progress":0,"water":0,"fertilizer":0},"type":"none","position":{"x":1120.839599609375,"y":-1040.17578125,"z":35.794921875}}'),
	(28, '{"health":{"progress":25.45999999999997,"water":0,"fertilizer":0},"type":"weed_seed","position":{"x":1123.147216796875,"y":-1039.3055419921876,"z":36.5699462890625}}');
...
-- Dumping data for table kkf.user_skills: ~0 rows (approximately)
DELETE FROM `user_skills`;
INSERT INTO `user_skills` (`pid`, `skills`) VALUES
	('1', '{"hacking":{"lvl":1,"progress":0},"cooking":{"lvl":1,"progress":0},"fishing":{"lvl":1,"progress":2.0},"mining":{"lvl":1,"progress":0},"sewing":{"lvl":1,"progress":0},"farming":{"lvl":1,"progress":0.3},"hunting":{"lvl":1,"progress":0},"crafting":{"lvl":1,"progress":0}}');
...
-- Dumping data for table kkf.user_vehicles: ~0 rows (approximately)
DELETE FROM `user_vehicles`;
INSERT INTO `user_vehicles` (`vehicle`, `owner`, `impoundable`, `stored`, `location`, `plate`, `type`, `ownername`, `fakeplate`, `model`, `trunk`, `glovebox`, `logbook`, `degradation`, `stance_data`) VALUES
	...
	('{"model":943752001,"plate":"ZHSF2737"}', '1', 1, 0, NULL, 'ZHSF2737', 'car', 'Tyson Stonehead', NULL, 'TUNDMATU', NULL, NULL, '[]', '{\r\n    "fuel_injector": [100.0, "Kütusepihusti"],\r\n    "radiator": [100.0, "Radiaator"],\r\n    "axle": [100.0, "Teljed"],\r\n    "transmission": [100.0, "Käigukast"],\r\n    "electronics": [100.0, "Elektroonika"],\r\n    "brakes": [100.0, "Pidurid"],\r\n    "clutch": [100.0, "Sidur"],\r\n    "tire": [100.0, "Rehvid"]\r\n}', NULL);
